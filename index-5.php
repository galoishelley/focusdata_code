...
<div class="content">
    ...
    <div class="thumb-box10">
        <div class="container">
            <h2 class="indent">Terms of Use</h2>
            <ul class="list9">
                <li class="wow fadeInUp">
                    <h3>Duis ultricies pharetra magna</h3>
                ...
                <li class="wow fadeInUp">
                    <a href="#" class="mail">focusdata@gmail.com</a>
                </li>
            </ul>
        </div>
    </div>
