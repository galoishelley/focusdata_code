                     ...
                     <form class="form-inline" role="form" id="modal_form_signup">
                        ...
                        <div class="row alexrow">
                           <div class="form-group">
                              ...
                              <select style="margin-left: 57px" class="form-control"  id="TITLE_ID"
                                 name="TITLE_ID">
                              </select>
                           </div>
                        </div>
                        <div class="row alexrow">
                           <div class="form-group">
                              ...
                              <input type="text" style="margin-left: 17px" class="form-control"
                        ...
                        <div class="row alexrow">
                           <div class="form-group">
                              ...
                              <select class="form-control"  style="margin-left: 40px" id="GENDER_ID"
                                 name="GENDER_ID">
                              </select>
                           </div>
                           <div class="form-group">
                        ...
                        <div class="row alexrow">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control"  style="margin-left: 42px"
					...
					<div class="search-time-container clearfix closed">
						<div class="search-time-scroll doctor-time-scroll">
							...
							{{for timeslot ~pdoctorid=doctorID}}
								<a class="apptTimeBtn" keyDoctorID="{{>~pdoctorid}}"
									keyDate="{{>~ppdate}}"
									keyTime="{{>originalTime}}">{{>time}}</a>
							{{/for}}
