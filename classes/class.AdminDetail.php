<?php
include_once ('class.AdminDetail_db.php');
// define _DBUG_LOG 1;
class AdminDetail
{
	private $AdminDetail;
	...
	{
		session_start ();
		$this->AdminDetail = new AdminDetail_DB();
		$this->_dbug = false;
	...
	public function view()
	{
		...
		$ret = $this->AdminDetail->view ($this->arr_values);
	...
	public function viewAll()
	{
		...
		$ret = $this->AdminDetail->viewAll ($this->arr_values);
	...
	public function update(){
		...
		$ret = $this->AdminDetail->update ($this->arr_values);
