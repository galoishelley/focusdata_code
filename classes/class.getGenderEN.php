<?php
include_once ('class.getGenderEN_db.php');
// define _DBUG_LOG 1;
class getGenderEN
{
	private $getGenderEN;
	...
	{
		session_start ();
		$this->getGenderEN = new getGenderEN_DB();
		$this->_dbug = false;
