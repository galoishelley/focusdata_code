<?php
include_once ('class.saveSearch_db.php');
// define _DBUG_LOG 1;
class saveSearch
{
	private $saveSearch;
	...
	{
		session_start ();
		$this->saveSearch = new saveSearch_DB();
		$this->_dbug = false;
   ...
   //      	$this->user_name = $this->arr_values['CUSTOMER_USER_NAME'];
	...
	public function create()
	{
		...
		$ret = $this->saveSearch->create($this->arr_values);
	...
	public function viewAll()
	{
		...
		$ret = $this->saveSearch->viewAll ($this->arr_values);
	...
	public function remove(){
		...
		$ret = $this->saveSearch->remove ($this->arr_values);
