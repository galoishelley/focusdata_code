<?php
include_once ('class.getAppDate_db.php');
// define _DBUG_LOG 1;
class getAppDate
{
	private $getAppDate;
	...
	{
		session_start ();
		$this->getAppDate = new getAppDate_DB();
		$this->_dbug = false;
	...
	public function viewAll()
	{
		...
		$ret = $this->getAppDate->viewAll ($this->arr_values);
	...
	public function viewAll_User()
	{
		...
		$ret = $this->getAppDate->viewAll_User ();
