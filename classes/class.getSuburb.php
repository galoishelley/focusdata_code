<?php
include_once ('class.getSuburb_db.php');
// define _DBUG_LOG 1;
class getSuburb
{
	private $getSuburb;
	...
	{
		session_start ();
		$this->getSuburb = new getSuburb_DB();
		$this->_dbug = false;
	...
	public function viewAll_User()
	{
		...
		$ret = $this->getSuburb->viewAll_User ();
