<?php
include_once ('class.qryDoctorAppTime_db.php');
// define _DBUG_LOG 1;
class qryDoctorAppTime
{
	private $qryDoctorAppTime;
	...
	{
		session_start ();
		$this->qryDoctorAppTime = new qryDoctorAppTime_DB();
		$this->_dbug = false;
		...
		if($this->_dbug){
	        echo "[---qryDoctorAppTime---arr_values]";
...
$qryDoctorAppTime = new qryDoctorAppTime();
?>