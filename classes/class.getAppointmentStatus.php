<?php
include_once ('class.getAppointmentStatus_db.php');
// define _DBUG_LOG 1;
class getAppointmentStatus
{
	private $getAppointmentStatus;
	...
	{
		session_start ();
		$this->getAppointmentStatus = new getAppointmentStatus_DB();
		$this->_dbug = false;
        ...
        if($this->_dbug){
            echo "[---getAppointmentStatus---request]";
		...
		if($this->_dbug){
	        echo "[---getAppointmentStatus---arr_values]";
	...
	public function viewAll()
	{
		...
		$ret = $this->getAppointmentStatus->viewAll ();
...
$getAppointmentStatus = new getAppointmentStatus();
?>