<?php
include_once ('class.getAppTimeID_db.php');
// define _DBUG_LOG 1;
class getAppTimeID
{
	private $getAppTimeID;
	...
	{
		session_start ();
		$this->getAppTimeID = new getAppTimeID_DB();
		$this->_dbug = false;
	...
	public function viewAll()
	{
		...
		$ret = $this->getAppTimeID->viewAll ($this->arr_values);
