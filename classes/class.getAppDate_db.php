...
class getAppDate_DB{
    ...
    public function viewAll($arr_values=0,$requesttype=0,$start=0,$lenght=10){
        ...
        $sql = "SELECT DISTINCT APPOINTMENT_DATE FROM `fd_rel_doctor_appointment_time` WHERE ACTIVE_STATUS = 1 and  `DOCTOR_ID` = ".$arr_values['DOCTOR_ID'] ." and APPOINTMENT_DATE >= curdate() ORDER BY APPOINTMENT_DATE ASC";
