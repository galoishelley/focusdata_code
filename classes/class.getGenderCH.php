<?php
include_once ('class.getGenderCH_db.php');
// define _DBUG_LOG 1;
class getGenderCH
{
	private $getGenderCH;
	...
	{
		session_start ();
		$this->getGenderCH = new getGenderCH_DB();
		$this->_dbug = false;
