    ...
    <div class="container">
        <ul class="nav sf-menu clearfix">
            ...
            <li class="sub-menu hidden" id="sign_in">
                ...
                <ul class="submenu sub-menu-login menu4phone">
                    <li>
                        <a href="sign_in.php">
            ...
            <li class="sub-menu hidden" id="sign_up">
                ...
                <ul class="submenu sub-menu-register menu4phone">
                    <li>
            ...
            <li class="sub-menu" id="langlang">
                ...
                <ul class="submenu sub-menu-languang menu4phone">
            ...
            <li class="sub-menu tourist" style="left:200px" id="userinfo">
                ...
                <ul class="submenu menu4phone" id="sub_userinfo">
                    <li>
                    ...
                    <li id="li_sign_out" class="hidden"><button class="btn btn-danger btn_out" style="
    height: 20px;
    padding-top: 0px;
    padding-bottom: 0px;font-size:12px;"><?php echo $lang['Lang0017']; ?></button></li>
                </ul>
