<nav class="navbar navbar-default navbar-static-top tm_navbar clearfix" role="navigation">
    <div class="container">
        <ul class="nav sf-menu clearfix">
            ...
            <li id="li_contacts"><a href="index-4.php"><!-- Contacts --><?php echo $lang['Lang0013']; ?></a></li>
            ...
            <li class="sub-menu tourist"><a href="#" id="userinfo"><!-- 游客 --><?php echo $lang['Lang0016']; ?></a><span></span>
                <ul class="submenu" id="sub_userinfo">
                    ...
                    <li id="li_sign_out" class="hidden"><button class="btn btn-danger" id="btn_out"><!-- 安全退出 --><?php echo $lang['Lang0017']; ?></button></li>
                </ul>
            </li>
        </ul>
    </div>
