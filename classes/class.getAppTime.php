<?php
include_once ('class.getAppTime_db.php');
// define _DBUG_LOG 1;
class getAppTime
{
	private $getAppTime;
	...
	{
		session_start ();
		$this->getAppTime = new getAppTime_DB();
		$this->_dbug = false;
	...
	public function viewAll()
	{
		...
		$ret = $this->getAppTime->viewAll ($this->arr_values);
	...
	public function viewAll_User()
	{
		...
		$ret = $this->getAppTime->viewAll_User ();
