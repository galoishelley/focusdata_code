			...
			<div class="thumb-box9" data-stellar-background-ratio="0.1">
				<div class="container">
					<div class="row df_content col-md-8 col-md-offset-2">
						...
						<form class="form-horizontal wow fadeInUp" role="form"
							id="signin_form">

							<fieldset>

								<div class="form-group">
									<label for="USER_MAIL" class="col-sm-2 control-label"><?php echo $lang['Lang0022']; ?><span
										class="span-red">*</span></label>
									<div class="col-sm-10">
										<input type="text" class="form-control" id="USER_MAIL"
											name="USER_MAIL"
											placeholder="<?php echo $lang['Lang0023']; ?>" autofocus>
									</div>
								</div>
								<div class="form-group">
									<label for="USER_PWD" class="col-sm-2 control-label"><?php echo $lang['Lang0024']; ?><span
										class="span-red">*</span></label>
									<div class="col-sm-10">
										<input type="password" class="form-control" id="USER_PWD"
											name="USER_PWD"
											placeholder="<?php echo $lang['Lang0025']; ?>">
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group pull-right">
										<button class="btn btn-lg btn-primary btn-block"
											id="signin_ok"><?php echo $lang['Lang0030']; ?></button>
									</div>
								</div>
								<div class="row">
									<div class="form-group pull-right">
