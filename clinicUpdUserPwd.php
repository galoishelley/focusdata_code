          ...
          <div class="PersonUser">
                ...
                <div class="row">
                  ...
                  <form class="form-inline wow fadeInLeft" role="form" id="userUpdPersonPwd">
                      ...
                      <div class="form-group col-md-10">
                        <label for="CLINIC_USER_PWD" class="col-md-5 control-label"><!-- 旧密码--><?php echo $lang['Lang0112']; ?><span class="span-red">*</span></label>
                        <input type="password" class="form-control" id="CLINIC_USER_PWD">
                      </div>

                      <div class="form-group col-md-10">
                        <label for="CLINIC_USER_NEWPWD" class="col-md-5 control-label"><!-- 新密码--><?php echo $lang['Lang0113']; ?><span class="span-red">*</span></label>
                        <input type="password" class="form-control" id="CLINIC_USER_NEWPWD">
                      </div>

                      <div class="form-group col-md-10">
                        <label for="CONFIRM_PWD" class="col-md-5 control-label"><!-- 确认新密码--><?php echo $lang['Lang0114']; ?><span class="span-red">*</span></label>
