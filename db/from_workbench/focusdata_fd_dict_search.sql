...
LOCK TABLES `fd_dict_search` WRITE;
/*!40000 ALTER TABLE `fd_dict_search` DISABLE KEYS */;
INSERT INTO `fd_dict_search` VALUES (1,'诊所区域'),(2,'诊所名称'),(3,'医生类别'),(4,'医生姓名'),(5,'预约时间'),(6,'医生距离');
/*!40000 ALTER TABLE `fd_dict_search` ENABLE KEYS */;
UNLOCK TABLES;
