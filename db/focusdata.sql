...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-09-06 22:58:25
...
(1, 'admin', 'admin', '', '0000-00-00 00:00:00', 'admin', '2016-09-06 12:40:28');
...
(1, 'shelleymyl', 'myl1102', 'shelleymyl@gmail.com11', '中华人民共和国吉林省长春市吉林大学第一医院', '吉林省长春市前进大街8811号1', 1, NULL, 'shelleymyl', '2016-08-13 12:11:10', 'shelleymyl1', '2016-09-04 16:09:32'),
(2, 'shelleymyle1', 'myl1102', 'shelleymyl@gmail.com1', '市诊所1', '南阳路88号1', 1, NULL, 'shelleymyl', '2016-08-13 12:11:39', 'admin', '2016-09-01 16:14:34'),
...
(11, 'admin', 'admin', 'shelleymyl@gmail.com', '12', '12', 1, NULL, 'admin', '2016-09-01 16:53:28', 'admin', '2016-09-05 21:54:23'),
(12, 'fuy', '1', 'shelleymyl@gmail.com', '吉林大学第一医院', '新民广场1102号', 0, NULL, 'fuy', '2016-09-06 10:30:19', 'admin', '2016-09-06 11:26:52');
...
(33, 'admin', 'admin', '尹小猫', '女', '1ee111', '1e111', '1eeeee111', '1e111', 0, '', 'admin', '2016-08-24 21:15:18', 'admin', '2016-09-05 22:02:27'),
(34, 'admin123', 'admin123', '尹小猫', '男', '1', '1', '1', '1', 0, '', 'admin123', '2016-08-24 21:19:27', 'admin123', '2016-08-24 21:19:27'),
...
(77, '111', '111', '1', '男', '', '1', '1', '1', 1, '', '111', '2016-09-04 23:20:25', '111', '2016-09-04 23:20:25'),
(78, '222', '222', '1', '男', '', '1', '1', '1', 1, '', '222', '2016-09-04 23:21:58', '222', '2016-09-04 23:21:58'),
(79, '11', '11', '11', '男', '', '1', '1', '1', 1, '', '11', '2016-09-05 19:40:58', '11', '2016-09-05 19:40:58'),
(80, '1111', '1111', '11', '男', '', '1', '1', '1', 1, '', '1111', '2016-09-05 19:43:46', '1111', '2016-09-05 19:43:46'),
(81, '11111', '11111', '11111', '男', '11111', '11111', '11111', '11111', 1, '', '11111', '2016-09-05 20:04:19', '11111', '2016-09-05 20:04:19'),
(82, 'miaoys', '1', '苗亚松', '男', '1988-7-30', '长春', '13500898235', '123456789', 1, '', 'miaoys', '2016-09-05 20:45:47', 'miaoys', '2016-09-05 21:12:04'),
(83, 'xingsj', '1', '邢素杰', '女', '1965-11-4', '吉林长春', '13500898234', '123456789', 0, '', 'xingsj', '2016-09-06 10:22:47', 'admin', '2016-09-06 12:21:26');
...
(1, '牙科', '尹鑫', '男', 0, 'miaoyl.jpg', '如果尽早治疗，根本不需要麻醉，补牙过程也异常简单，因为没有腐蚀到牙神经；而如果牙齿腐蚀的比较厉害接触要牙神经再来就诊，首先在治疗之前疼痛感比较强烈而且会伴随牙周炎等口腔炎症，麻醉过程中不会疼痛只会有肿胀感，麻醉后还是有一些不适。', '', 'admin', '2016-08-16 00:00:00', 'shelleymyl1', '2016-08-31 21:08:10'),
(2, '内科1', '苗亚柳1', '男', 1, 'bg_pic.jpg', 'gooddoctor01', '', 'admin', '2016-08-16 00:00:00', 'admin', '2016-08-16 00:00:00'),
(3, '牙科', '尹小猫', '女', 0, 'page1_pic3.jpg', '多张图片上传,显示...jquery多图片上传所属分类:输入-上传5041520085分享到:查看演示立即下载插件描述:多张图片上传,显示html部分', '1', 'admin', '2016-08-22 00:00:00', 'admin', '2016-08-22 00:00:00'),
...
CREATE TABLE IF NOT EXISTS `fd_save_search` (
  ...
  `DOCTOR_TYPE` varchar(50) NOT NULL,
  `DOCTOR_NAME` varchar(50) NOT NULL,
  `APPOINTMENT_DATE_BEGIN` varchar(50) NOT NULL,
  `APPOINTMENT_DATE_END` varchar(50) NOT NULL,
...
INSERT INTO `fd_save_search` (`CUSTOMER_SEARCH_ID`, `CUSTOMER_USER_ID`, `SEARCH_NAME`, `CLINIC_ADDR`, `CLINIC_NAME`, `DOCTOR_TYPE`, `DOCTOR_NAME`, `APPOINTMENT_DATE_BEGIN`, `APPOINTMENT_DATE_END`, `DISTANCE`, `CREATE_USER`, `CREATE_DATE`, `UPDATE_USER`, `UPDATE_DATE`) VALUES
(13, 33, '', '朝阳区', '', '', '', '', '', 'ANAY', 'admin', '2016-08-29 22:34:35', 'admin', '2016-08-29 22:34:35'),
(15, 82, '', '', '', '', '', '2016-09-0500:00', '2016-09-0523:59', 'ANAY', 'miaoys', '2016-09-05 21:46:22', 'miaoys', '2016-09-05 21:46:22'),
(16, 82, '', '', '', '', '', '2016-09-0500:00', '2016-09-0523:59', 'ANAY', 'miaoys', '2016-09-05 21:47:10', 'miaoys', '2016-09-05 21:47:10'),
(18, 83, '', '朝阳区', '市', '牙科', '鑫', '2016-09-0600:00', '2016-09-0623:59', 'ANAY', 'xingsj', '2016-09-06 10:24:30', 'xingsj', '2016-09-06 10:24:30');
...
DROP TABLE IF EXISTS `fd_state`;
CREATE TABLE IF NOT EXISTS `fd_state` (
...
INSERT INTO `fd_state` (`STATE_ID`, `STATE_POSTCODE`, `STATE_NAME`) VALUES
(1, '9010', 'QLD'),
(2, '3842', 'VIC');
