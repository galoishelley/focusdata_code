		...
		<div class="thumb-box9" data-stellar-background-ratio="0.1">
			<div class="container">
				<div class="row df_content">
					<h2 class="wow fadeInRight"><!-- 诊所用户注册--><?php echo $lang['Lang0192']; ?></h2>
					...
					<!-- 		<div class="form-group has-error has-feedback">
							...
							<div class="form-group">
								<label for="sele_user" class="control-label"><!-- 选择用户--><?php echo $lang['Lang0193']; ?><span class="span-red">*</span></label>
							...
							<div id="personal">
								...
								<div class="form-group col-md-6 col-lg-6">
	                              <label for="STATE_ID"><!-- 州--><?php echo $lang['Lang0204']; ?><span class="span-red">*</span></label>
							...
							<div class="row">
								<div class="form-group pull-right">
									<button type="submit" class="btn btn-lg btn-primary btn-block" id="signup_ok"><!-- Sign up for free--><?php echo $lang['Lang0205']; ?></button>
								 </div>
							</div>
							<div class="row">
								<div class="pull-right">
									<a href="sign_in.php"><strong><!-- sign in--><?php echo $lang['Lang0206']; ?></strong></a>
								</div>
							</div>
						</fieldset>
					</form>
