...
///////////////////////////////////组织ajax 请求参数 begin///////////////////////////////
    ...
    $.ajax({
          ...
          success: function (msg) {
            ...
            if(ret.success){
              if(json_str.sequ != ret.sequ){
                alert("CU04:时序号错误,请联系管理员ret.sequ"+ret.sequ+" json_str.sequ:"+json_str.sequ);
                result=false;
              }
              ...
              // history.go(-1);
              // // window.location.href="index.html";
              alert("CU04 "+ret.status.ret_code + " " + ret.status.ret_msg);
              refresh();
            }else{
              alert("CU04 "+ret.status.ret_code + " " + ret.status.ret_msg);
          ...
          error: function(XMLHttpRequest, textStatus, errorThrown){
            ...
            var ret_code = "999999";
            var ret_msg = "失败,请联系管理员!";
            alert("CU04 "+ret_code + ":" + ret_msg +" textStatus:"+ textStatus);
            result=false;
          }
      });
      if(!result){
