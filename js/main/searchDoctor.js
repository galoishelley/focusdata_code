		...
		$.ajax({
			...
			success: function (msg) {
				...
				if (ret.success) {
					...
					// $("#TMP_Clinic_Tab").prepend("<li><a id=\"tab_Home\" href=\"index.php\">Home</a></li>");
					...
					$("#TMP_Clinic_Tab").append("<li><a id=\"tab_Advanced_Search\" href=\"#\" data-toggle=\"modal\" data-target=\"#searchModal\">Search</a></li>");
